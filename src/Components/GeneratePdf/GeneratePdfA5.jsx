...
const hauteur = 595.276;
const largeur = 419.528;
const marginSide = 62.93;
const marginTop = 52.44;
...
function GeneratePdf(props) {
  const generate = () => {
    ...
    pdfMake.createPdf(dd).download(`${head.title} - A5.pdf`);
  };

  return (
    <div className="listPdf">
      <Button className="buttonPdf" onClick={generate}>Livre Roman A5</Button>
    </div>
  );
}
